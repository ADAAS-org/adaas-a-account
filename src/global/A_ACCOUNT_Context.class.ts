 ...
 */
export class A_ACCOUNT_ContextClass extends A_AUTH_ContextClass {
    ...
    constructor() {
        super({
            namespace: 'a-account',
            errors: A_ACCOUNT_CONSTANTS__DEFAULT_ERRORS
        });
    }
...
export const A_ACCOUNT_Context = new A_ACCOUNT_ContextClass()