...
// =========================  ORGANIZATION UNIT TYPE LIST REQUEST API TYPES ================================
...
// =========================  ORGANIZATION UNIT TYPE GET REQUEST API TYPES ================================
...
// =========================  ORGANIZATION UNIT TYPE CREATE REQUEST API TYPES ================================
...
// =========================  ORGANIZATION UNIT TYPE UPDATE REQUEST API TYPES ================================
export type A_ACCOUNT_APP_INTERACTIONS_TYPES__OrganizationUnitTypeUpdateRequest = A_SDK_TYPES__Required<
    A_SDK_TYPES__DeepPartial<A_ACCOUNT_TYPES__OrganizationUnitType_APIEntity>, [
        'aseid'
    ]> & {
        /**
         * Organization identifier in ADAAS System
