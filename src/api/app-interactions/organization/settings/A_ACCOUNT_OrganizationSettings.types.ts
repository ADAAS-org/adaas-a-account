...
} from "@adaas/a-sdk/api/app-interactions/common/A_ACCOUNT_Common.types"
...
// =========================  ORGANIZATION SETTINGS GET REQUEST API TYPES ================================
...
// =========================  ORGANIZATION SETTINGS UPDATE REQUEST API TYPES ================================
