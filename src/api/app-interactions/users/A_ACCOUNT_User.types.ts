...
export type A_ACCOUNT_APP_INTERACTIONS_TYPES__UserGetResponse = A_SDK_TYPES__Required<
...
export type A_ACCOUNT_APP_INTERACTIONS_TYPES__UserUpdateResponse = A_SDK_TYPES__Required<
    A_SDK_TYPES__DeepPartial<A_ACCOUNT_TYPES__User_APIEntity>,
    [
        'aseid'
    ]>
